...
urlpatterns = [
    ...
    path('admin-operations/', operations_dashboard, name='operations_dashboard'),
    ...
    path('admin-attendance/deployment/<int:deployment_id>/review/', runner_deployment_review, name='runner_deployment_review'),
    path('admin-attendance/deployment/<int:deployment_id>/return/', runner_deployment_return, name='runner_deployment_return'),
